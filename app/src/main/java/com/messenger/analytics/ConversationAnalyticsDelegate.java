   ...
   public void trackOpenedConversation(@NotNull DataConversation openedConversation, @NotNull List<DataUser> participants) {
      ...
      switch (analyticsType) {
         ...
         case CHAT_WITH_HOST:
            ...
            break;
         case GROUP_CHAT:
            openGroupConversation(MESSENGER_VALUE_GROUP, conversationSubject, count);
            break;
         case TRIP_CHAT:
            openGroupConversation(MESSENGER_VALUE_TRIP_CHAT, conversationSubject, count);
            break;
         case TRIP_CHAT_WITH_HOST:
            openGroupConversation(MESSENGER_VALUE_TRIP_CHAT_WITH_HOST, conversationSubject, count);
            break;
      }
   }
