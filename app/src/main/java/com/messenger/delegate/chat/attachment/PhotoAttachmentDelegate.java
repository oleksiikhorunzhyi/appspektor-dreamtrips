...
public class PhotoAttachmentDelegate {
    ...
    public void retry(String conversationId, DataMessage dataMessage, DataAttachment dataAttachment) {
        photoDAO.getAttachmentById(dataAttachment.getId())
                .take(1)
                .subscribe(photoAttachment -> sendImageInternally(conversationId, dataMessage,
                        dataAttachment, photoAttachment),
    ...
    private void sendImageInternally(String conversationId, DataMessage dataMessage,
                                     DataAttachment dataAttachment, DataPhotoAttachment dataPhotoAttachment) {
