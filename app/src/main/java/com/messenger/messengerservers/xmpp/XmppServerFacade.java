...
public class XmppServerFacade implements MessengerServerFacade {
   ...
   private MessengerConnection createConnection() {
      ...
      connection.addAsyncStanzaListener(packet -> CrashlyticsTracker.trackError(new SmackException(packet.toString())), stanza -> stanza != null && stanza
            .getError() != null && !TextUtils.isEmpty(stanza.getError().toString()));
      return connection;
   }
   ...
   public void connect(String username, String password) {
      ...
      }).subscribeOn(Schedulers.from(executor)).subscribe(this::connected, e -> Timber.e(e, "connection error"));
   }
