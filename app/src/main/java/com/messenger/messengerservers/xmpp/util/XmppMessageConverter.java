...
public final class XmppMessageConverter {
   ...
   public Message convert(org.jivesoftware.smack.packet.Message message) {
      Message.Builder builder = new Message.Builder().messageBody(messageBodyParser.parseMessageBody(message.getBody()))
   ...
   public Message convertSystemMessage(org.jivesoftware.smack.packet.Message message, SystemMessageExtension systemMessageExtension) {
      Message.Builder builder = new Message.Builder().conversationId(JidCreatorHelper.obtainId(message.getFrom()))
            .id(message.getStanzaId());
      if (systemMessageExtension.getTo() != null) {
         builder.toId(JidCreatorHelper.obtainId(systemMessageExtension.getTo()));
      }
      return builder.fromId(JidCreatorHelper.obtainId(systemMessageExtension.getFrom()))
