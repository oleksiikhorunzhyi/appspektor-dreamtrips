...
public abstract class BaseTableMigration extends BaseMigration {
   ...
   public void addColumn(SQLiteDatabase sqLiteDatabase, String tableName, String dataType, String columnName) {
   ...
   public void updateAllRowsInColumn(SQLiteDatabase sqLiteDatabase, String tableName, String column, String value) {
