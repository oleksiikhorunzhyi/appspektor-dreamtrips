...
public class MessengerConnector {
    ...
    private MessengerConnector(Context applicationContext, ActivityWatcher activityWatcher,
        ...
        this.messengerCacheSynchronizer = new MessengerCacheSynchronizer(messengerServerFacade, new UserProcessor(usersDAO, spiceManager), conversationsDAO, participantsDAO, messageDAO, usersDAO);
