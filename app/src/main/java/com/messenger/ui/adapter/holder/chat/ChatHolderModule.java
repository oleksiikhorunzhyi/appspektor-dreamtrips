...
public class ChatHolderModule {
   ...
   ChatViewHolderInfo provideOwnTextMessageViewHolderInfo() {
      return new ChatViewHolderInfo.Builder().viewType(VIEW_TYPE_OWN_TEXT_MESSAGE)
   ...
   ChatViewHolderInfo provideUserTextMessageViewHolderInfo() {
      return new ChatViewHolderInfo.Builder().viewType(VIEW_TYPE_USER_TEXT_MESSAGE)
   ...
   ChatViewHolderInfo provideOwnImageMessageViewHolderInfo() {
      return new ChatViewHolderInfo.Builder().viewType(VIEW_TYPE_OWN_IMAGE_MESSAGE)
   ...
   ChatViewHolderInfo provideUserImageMessageViewHolderInfo() {
      return new ChatViewHolderInfo.Builder().viewType(VIEW_TYPE_USER_IMAGE_MESSAGE)
   ...
   ChatViewHolderInfo provideOwnLocationMessageHolderInfo() {
      return new ChatViewHolderInfo.Builder().viewType(VIEW_TYPE_OWN_LOCATION_MESSAGE)
   ...
   ChatViewHolderInfo provideUserLocationMessageHolderInfo() {
      return new ChatViewHolderInfo.Builder().viewType(VIEW_TYPE_USER_LOCATION_MESSAGE)
   ...
   ChatViewHolderInfo provideSystemMessageHolderInfo() {
      return new ChatViewHolderInfo.Builder().viewType(VIEW_TYPE_SYSTEM_MESSAGE)
