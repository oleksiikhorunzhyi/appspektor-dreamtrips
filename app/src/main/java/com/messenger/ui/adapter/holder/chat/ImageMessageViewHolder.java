...
public abstract class ImageMessageViewHolder extends UserMessageViewHolder {
   ...
   @InjectView(R.id.chat_image_post_image_view) SimpleDraweeView imagePostView;
   @InjectView(R.id.chat_image_post_progress_bar) ProgressBar progressBar;
   @InjectView(R.id.chat_image_error) View errorView;
   ...
   private void showImageMessage(@Nullable String strUri, @Nullable String strLocalUri) {
      ...
      DraweeController controller = GraphicUtils.provideFrescoResizingControllerBuilder(strUri, strLocalUri, imagePostView
            .getController(), width, height).setControllerListener(controllerListener).build();
