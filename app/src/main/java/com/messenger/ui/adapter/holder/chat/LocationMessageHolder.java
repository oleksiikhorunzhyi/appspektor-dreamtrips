...
public abstract class LocationMessageHolder extends UserMessageViewHolder {
   ...
   @InjectView(R.id.lite_map_view) MapView mapView;
   ...
   public void bindCursor(Cursor cursor) {
      ...
      DataLocationAttachment dataLocationAttachment = SqlUtils.convertToModel(true, DataLocationAttachment.class, cursor);
