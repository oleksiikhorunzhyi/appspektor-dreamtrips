...
public class ConversationLastMessageDateInflater extends ViewInflater {
   ...
   public void setView(View rootView) {
      ...
      todayDateFormat = new SimpleDateFormat(context.getString(R.string.conversation_list_last_message_date_format_today));
      moreThanTwoDaysAgoFormat = new SimpleDateFormat(context.getString(R.string.conversation_list_last_message_date_format_more_than_one_day_ago));
   }
