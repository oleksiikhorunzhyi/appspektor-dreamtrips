      ...
      Runnable task = () -> {
         ...
         if (ivImage != null && ivImage.getWidth() > 0 && ivImage.getHeight() > 0) {
            ...
            DraweeController draweeController = Fresco.newDraweeControllerBuilder()
                  .setLowResImageRequest(GraphicUtils.createResizeImageRequest(Uri.parse(image.getUrl()), previewWidth, previewHeight))
                  .setImageRequest(GraphicUtils.createResizeImageRequest(Uri.parse(image.getUrl()), ivImage.getWidth(), ivImage
                        .getHeight()))
                  .build();
