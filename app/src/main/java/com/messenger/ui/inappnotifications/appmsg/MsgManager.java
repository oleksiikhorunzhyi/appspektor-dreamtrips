...
class MsgManager extends Handler implements Comparator<AppMsg> {
    ...
    void add(AppMsg appMsg) {
        ...
        if (appMsg.inAnimation == null) {
            appMsg.inAnimation = AnimationUtils.loadAnimation(appMsg.getActivity(),
                    android.R.anim.fade_in);
        }
        if (appMsg.outAnimation == null) {
            appMsg.outAnimation = AnimationUtils.loadAnimation(appMsg.getActivity(),
    ...
    private void displayMsg() {
        ...
        if (!appMsg.isShowing()) {
            ...
            sendMessageDelayed(msg, appMsg.getDuration()
                    + appMsg.inAnimation.getDuration() + appMsg.outAnimation.getDuration());
        }
    }
