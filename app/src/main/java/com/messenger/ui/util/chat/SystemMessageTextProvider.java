...
public class SystemMessageTextProvider {
   ...
   private Spanned obtainJoinSystemMessage(String conversationType, DataUser sender, DataUser recipient) {
      if (ConversationHelper.isTripChat(conversationType)) {
         if (isItMe(recipient)) {
            return ProjectTextUtils.fromHtml(resources.getString(R.string.system_message_you_are_added));
         } else {
            return ProjectTextUtils.fromHtml(resources.getString(R.string.system_message_is_added, recipient.getDisplayedName()));
         }
      } else {
         return ProjectTextUtils.fromHtml(resources.getString(R.string.system_message_added, obtainAdminText(sender), obtainUserTextWithoutCapitalLetter(recipient)));
      }
   }
   ...
   private Spanned obtainKickSystemMessage(String conversationType, DataUser sender, DataUser recipient) {
      if (ConversationHelper.isTripChat(conversationType)) {
         if (isItMe(recipient)) {
            return ProjectTextUtils.fromHtml(resources.getString(R.string.system_message_you_are_removed));
         } else {
            return ProjectTextUtils.fromHtml(resources.getString(R.string.system_message_is_removed, recipient.getDisplayedName()));
         }
      } else {
         return ProjectTextUtils.fromHtml(resources.getString(R.string.system_message_removed, obtainAdminText(sender), obtainUserTextWithoutCapitalLetter(recipient)));
      }
   }
   ...
   private String obtainUserTextWithoutCapitalLetter(DataUser recipient) {
      return isItMe(recipient) ? resources.getString(R.string.system_message_you)
            .toLowerCase() : recipient.getDisplayedName();
   }

   private String obtainAdminText(DataUser sender) {
      return isItMe(sender) ? resources.getString(R.string.system_message_you) : resources.getString(R.string.system_message_admin, sender
            .getDisplayedName());
   }
