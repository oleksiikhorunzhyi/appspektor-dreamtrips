...
public class ChatUsersTypingView extends RelativeLayout {
   ...
   @InjectViews({R.id.chat_typing_avatar_1, R.id.chat_typing_avatar_2, R.id.chat_typing_avatar_3}) List<SimpleDraweeView> avatarImageViews;
   @InjectViews({R.id.chat_typing_circle_1, R.id.chat_typing_circle_2, R.id.chat_typing_circle_3}) List<ImageView> typingCircles;
   ...
   private void updateUI() {
      ...
      if (typingUsers.size() > avatarImageViews.size()) {
         ...
         String moreTypingUsers = String.format(getContext().getString(R.string.chat_more_typing_users_hint_format), sizeDiff);
