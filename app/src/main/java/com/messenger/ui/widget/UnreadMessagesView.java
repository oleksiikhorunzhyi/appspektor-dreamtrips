...
public class UnreadMessagesView extends CardView {
    ...
    private void init() {
        ButterKnife.inject(this, LayoutInflater
                .from(getContext()).inflate(R.layout.widget_unread_messages, this, true));
    }
    ...
    public void updateCount(int unreadMessagesCount) {
        unreadMessagesTextView.setText(String.format(getResources()
                .getString(R.string.chat_unread_messages_textview_format), unreadMessagesCount));
    }
}