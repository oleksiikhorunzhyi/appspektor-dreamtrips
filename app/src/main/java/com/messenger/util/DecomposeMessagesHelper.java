...
public class DecomposeMessagesHelper {
   ...
   public static class Result {
      ...
      public Result(List<DataMessage> messages, List<DataAttachment> attachments, List<DataPhotoAttachment> photoAttachments, List<DataLocationAttachment> locationAttachments) {
