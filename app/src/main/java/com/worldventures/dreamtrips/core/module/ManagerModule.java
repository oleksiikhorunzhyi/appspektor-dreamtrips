...
public class ManagerModule {
   ...
   @Provides
   @Singleton
   ReactiveNetworkConnectionStateProvider provideReactiveNetworkConnectionStateProvider(Context context) {
      return new ReactiveNetworkConnectionStateProvider(context);
   }
}
