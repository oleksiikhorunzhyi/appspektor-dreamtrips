...
public class BaseImageFragment<T extends ImagePathHolder>
        extends BaseFragmentWithArgs<BaseImagePresenter<T>, ImageBundle<T>>
        implements BaseImagePresenter.View {
