...
@CommandAction
public class UploadPhotoControllerCommand extends Command<List<EntityStateHolder<BucketPhoto>>>
        implements CachedAction<List<EntityStateHolder<BucketPhoto>>> {
    ...
    private UploadPhotoControllerCommand(String bucketId,
                                         Func1<List<EntityStateHolder<BucketPhoto>>, List<EntityStateHolder<BucketPhoto>>> actionFunc) {
