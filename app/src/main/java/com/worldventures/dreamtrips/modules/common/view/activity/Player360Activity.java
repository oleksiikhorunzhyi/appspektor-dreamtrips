...
public class Player360Activity extends ActivityWithPresenter<VideoPlayerPresenter> implements PFAssetObserver, VideoPlayerPresenter.View {
   ...
   @InjectView(R.id.framecontainer) protected ViewGroup frameContainer;
   @InjectView(R.id.media_controls) protected PFViewMediaControls mediaControls;
   @InjectView(R.id.topBar) protected View topBarHolder;
