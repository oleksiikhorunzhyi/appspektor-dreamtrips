...
public class PFViewMediaControls extends RelativeLayout {
   ...
   @IntDef({MODE_SPHERICAL, MODE_FLAT_DISPLAY, MODE_STEREO_SIDE_BY_SIDE})
   @Retention(RetentionPolicy.SOURCE)
   public @interface CardBoardMode {}

   @InjectView(R.id.pf_control_seek) SeekBar seekBar;
   @InjectView(R.id.pf_control_time) TextView timeText;
   @InjectView(R.id.pf_control_play_pause) ToggleButton toggleBtnPlayPause;
   @InjectView(R.id.pf_control_card_board) ToggleButton toggleBtnCardBoardMode;
   @InjectView(R.id.pf_holdbtn_backward) HoldableButton holdableBtnBackward;
   @InjectView(R.id.pf_holdbtn_forward) HoldableButton holdableBtnForward;
