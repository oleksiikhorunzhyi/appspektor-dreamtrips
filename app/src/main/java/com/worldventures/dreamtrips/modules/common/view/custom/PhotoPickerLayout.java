...
public class PhotoPickerLayout extends SlidingUpPanelLayout {
   ...
   @InjectView(R.id.button_cancel) TextView cancel;
   @InjectView(R.id.button_done) TextView done;
   @InjectView(R.id.selected_count) TextView selectedCount;
   @InjectView(R.id.photo_container) ViewGroup container;
