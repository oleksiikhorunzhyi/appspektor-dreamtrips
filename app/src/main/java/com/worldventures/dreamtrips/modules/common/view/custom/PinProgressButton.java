...
public class PinProgressButton extends CompoundButton {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mTempRect.set(mDrawableSize / 4, mDrawableSize / 4,
                mDrawableSize * 3 / 4, mDrawableSize * 3 / 4);
        Drawable iconDrawable = failed ? errorDrawable :
                mProgress == mMax ? successDrawable : progressDrawable;
