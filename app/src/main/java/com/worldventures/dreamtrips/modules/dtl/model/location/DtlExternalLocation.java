...
public class DtlExternalLocation implements DtlLocation, Parcelable {
   ...
   public String getAnalyticsName() {
      return String.format("%s:%s:%s", longName, getLongNameFor(DtlLocationType.STATE), getLongNameFor(DtlLocationType.COUNTRY));
   }
   ...
   public static class DtlNearestComparator implements Comparator<DtlExternalLocation> {
      ...
      public int compare(DtlExternalLocation lhs, DtlExternalLocation rhs) {
         double distanceToLeft = DtlLocationHelper.distanceInMiles(currentLocation, lhs.getCoordinates().asLatLng());
         double distanceToRight = DtlLocationHelper.distanceInMiles(currentLocation, rhs.getCoordinates().asLatLng());
         //
   ...
   public static Comparator<DtlExternalLocation> CATEGORY_COMPARATOR = (lhs, rhs) -> lhs.type.ordinal() - rhs.type.ordinal();

   public static Comparator<DtlExternalLocation> ALPHABETICAL_COMPARATOR = (lhs, rhs) -> lhs.getLongName()
         .compareToIgnoreCase(rhs.getLongName());
   ...
   public static class DtlLocationRangeComparator implements Comparator<DtlExternalLocation> {
      ...
      @Override
      public int compare(DtlExternalLocation lhs, DtlExternalLocation rhs) {
         int rangeSortResult = ProjectTextUtils.substringLocation(lhs.getLongName(), subString) - ProjectTextUtils.substringLocation(rhs
               .getLongName(), subString);
