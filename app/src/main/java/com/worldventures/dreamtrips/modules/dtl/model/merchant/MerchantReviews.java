...
@Gson.TypeAdapters
@Value.Immutable
public interface MerchantReviews extends Identifiable<String> {
   ...
   @Nullable @SerializedName("categories") List<com.worldventures.dreamtrips.api.dtl.merchants.model.ThinAttribute> categories();
   @Nullable @SerializedName("amenities") List<com.worldventures.dreamtrips.api.dtl.merchants.model.ThinAttribute> amenities();
