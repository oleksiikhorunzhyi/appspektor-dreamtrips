...
public abstract class DtlOffer implements Comparable<DtlOffer> {
   ...
   public DtlOffer(com.worldventures.dreamtrips.api.dtl.merchants.model.Offer offer) {
      ...
      operationDays = Queryable.from(offer.offerData().operationDays()).map(OperationDay::new).toList();
   ...
   public boolean equals(Object o) {
      ...
      if (disclaimer != null ? !disclaimer.equals(that.disclaimer) : that.disclaimer != null) return false;
      if (startDate != null ? !startDate.equals(that.startDate) : that.startDate != null) return false;
      if (endDate != null ? !endDate.equals(that.endDate) : that.endDate != null) return false;
      if (operationDays != null ? !operationDays.equals(that.operationDays) : that.operationDays != null) return false;
   ...
   public enum Type {
      ...
      public static Type of(final String type) {
         final Type entry = Queryable.from(values()).firstOrDefault(typed -> typed.value().equalsIgnoreCase(type));
