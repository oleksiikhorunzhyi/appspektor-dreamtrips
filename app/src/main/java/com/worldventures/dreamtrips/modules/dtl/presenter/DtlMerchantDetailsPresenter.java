...
public class DtlMerchantDetailsPresenter extends DtlMerchantCommonDetailsPresenter<DtlMerchantDetailsPresenter.View> {
    ...
    public DtlMerchantDetailsPresenter(DtlMerchant merchant) {
        super(merchant);
    }
    ...
    public void onMerchantClick() {
        view.openSuggestMerchant(new SuggestMerchantBundle(merchant));
    }
    ...
    public void onBackPressed() {
        ...
        view.openMap(new MerchantsBundle(dtlLocation));
    }
    ...
    public interface View extends DtlMerchantCommonDetailsPresenter.View, RxView {
        ...
        void openSuggestMerchant(SuggestMerchantBundle data);
        ...
        void openMap(MerchantsBundle merchantsBundle);
