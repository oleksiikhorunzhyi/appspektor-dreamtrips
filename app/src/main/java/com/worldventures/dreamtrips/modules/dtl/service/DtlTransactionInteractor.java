...
public class DtlTransactionInteractor {
   ...
   public DtlTransactionInteractor(SessionActionPipeCreator sessionActionPipeCreator) {
      estimatePointsActionPipe = sessionActionPipeCreator.createPipe(EstimatePointsHttpAction.class, Schedulers.io());
      rateActionPipe = sessionActionPipeCreator.createPipe(AddRatingHttpAction.class, Schedulers.io());
