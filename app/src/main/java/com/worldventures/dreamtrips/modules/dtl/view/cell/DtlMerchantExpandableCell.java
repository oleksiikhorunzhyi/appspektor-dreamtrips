...
public class DtlMerchantExpandableCell extends AbstractDelegateCell<DtlMerchant, DtlMerchantCellDelegate> {
   ...
   private void setOfferBadges(int perks, int points) {
      int perkVisibility = getModelObject().isExpanded() ? View.GONE : perks > 0 ? View.VISIBLE : View.GONE;
      int pointVisibility = getModelObject().isExpanded() ? View.GONE : points > 0 ? View.VISIBLE : View.GONE;
