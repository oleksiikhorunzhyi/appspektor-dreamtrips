...
public class DtlMerchantsListFragment
        extends RxBaseFragment<DtlMerchantsListPresenter>
        implements DtlMerchantsListPresenter.View {
    ...
    @Override
    protected DtlMerchantsListPresenter createPresenter(Bundle savedInstanceState) {
        return new DtlMerchantsListPresenter((DtlMerchantType) getArguments().getSerializable(EXTRA_TYPE));
    }
