...
public abstract class SuggestMerchantBaseFragment<T extends SuggestRestaurantBasePresenter>
        extends BaseFragmentWithArgs<T, SuggestMerchantBundle>
    ...
    public boolean onApiError(ErrorResponse errorResponse) {
        ...
        if (errorResponse.containsField(DtlLead.COMMENT)) {
            additionalInfo.setError(errorResponse.getMessageForField(DtlLead.COMMENT));
        }
        return false;
    }
