...
public class TransactionsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   private void drawView(RecyclerView.ViewHolder holder, int position) {
      ...
      viewHolder.transactionDate.setText(DtlDateTimeUtils.getStringDateFromStringUTC(transactionsList.get(position)
            .getTransactionDate()));
   }

   private String getEarnedText(int earnedPoints) {
