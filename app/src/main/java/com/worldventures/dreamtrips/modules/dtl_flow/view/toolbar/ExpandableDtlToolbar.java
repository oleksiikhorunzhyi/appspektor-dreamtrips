...
public class ExpandableDtlToolbar extends DtlToolbar {
    ...
    protected void initAttributes(AttributeSet attrs) {
        ...
        navigationControlVisible = a.getBoolean(R.styleable.ExpandableDtlToolbar_dtlt_navigation_icon_visible,
                DEF_NAVIGATION_ICON_VISIBLE);
        showFilterBar = a.getBoolean(R.styleable.ExpandableDtlToolbar_dtlt_show_filter_bar_portrait,
                DEF_SHOW_FILTER_BAR);
