...
public abstract class FeedHeaderCell<T extends FeedItem> extends AbstractCell<T> implements Flaggable {
    ...
    protected void syncUIStateWithModel() {
        ...
        if (!getModelObject().getType().equals(FeedItem.Type.TRIP)) {
    ...
    public void showFlagDialog(List<Flag> flags) {
        FlagPopupMenu popupMenu = new FlagPopupMenu(itemView.getContext(), more);
        popupMenu.show(flags, (reason, desc) -> getEventBus().post(new ItemFlaggedEvent(getModelObject().getItem(),
                reason + ". " + desc)));
    }
