...
public class NewLocationPushMessage extends NewMessagePushMessage {
   ...
   public NewLocationPushMessage(AlertWrapper alertWrapper, String latitudeLongitude, int notificationId,
         int notificationsCount, int requestsCount, String conversationId, int unreadConversationsCount) {
