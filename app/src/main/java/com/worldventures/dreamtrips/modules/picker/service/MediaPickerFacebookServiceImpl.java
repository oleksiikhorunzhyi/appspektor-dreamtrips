package com.worldventures.dreamtrips.modules.picker.service;
...
public class MediaPickerFacebookServiceImpl implements MediaPickerFacebookService {
   ...
   public MediaPickerFacebookServiceImpl(Activity activity) {
