...
public class PickLocationViewImpl extends MvpLinearLayout<PickLocationView, PickLocationPresenter> implements PickLocationView {
   ...
   @InjectView(R.id.pick_location_toolbar) Toolbar toolbar;
   @InjectView(R.id.pick_location_no_play_services) View noPlayServicesOverlay;
   ...
   @State boolean isCurrentLocationSet;
   ...
   public void showRationalForLocationPermission() {
      Snackbar.make(this, R.string.permission_location_rationale, Snackbar.LENGTH_SHORT).show();
   }

   @Override
   public void showDeniedLocationPermissionError() {
      Snackbar.make(this, R.string.no_location_permission, Snackbar.LENGTH_SHORT).show();
   }
