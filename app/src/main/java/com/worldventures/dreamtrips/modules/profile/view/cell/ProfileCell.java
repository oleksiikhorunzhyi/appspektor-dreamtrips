...
public class ProfileCell extends AbstractDelegateCell<User, ProfileCellDelegate> implements Expandable {
   ...
   private void setTripImagesCount(int count) {
      int stringResource = QuantityHelper.chooseResource(count, R.string.profile_zero_trip_images, R.string.profile_trip_images, R.string.profile_trip_images);
      tripImages.setText(String.format(context.getString(stringResource), count));
   }

   private void setBucketItemsCount(int count) {
      int stringResource = QuantityHelper.chooseResource(count, R.string.profile_zero_bucket_list, R.string.profile_bucket_list, R.string.profile_bucket_list);
   ...
   private void setIsFriend(boolean isFriend) {
      ...
      addFriend.setCompoundDrawablesWithIntrinsicBounds(0, isFriend ? R.drawable.ic_profile_friend : R.drawable.ic_profile_add_friend_selector, 0, 0);
   }

   private void setWaiting() {
      addFriend.setText(R.string.profile_waiting);
      addFriend.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_profile_friend_respond, 0, 0);
   }

   private void setRespond() {
      addFriend.setText(R.string.profile_respond);
      addFriend.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_profile_respond, 0, 0);
   }
