...
@CommandAction
public class UnlikeSuccessStoryCommand extends BaseLikeActionCommand<UnlikeSuccessStoryHttpAction> {
   ...
   @Override
   Class<UnlikeSuccessStoryHttpAction> getActionClass() {
      return UnlikeSuccessStoryHttpAction.class;
   }

   @Override
   UnlikeSuccessStoryHttpAction getAction() {
