...
import com.worldventures.dreamtrips.modules.trips.api.GetTripDetails;
import com.worldventures.dreamtrips.modules.trips.api.LikeTrip;
import com.worldventures.dreamtrips.modules.trips.api.UnlikeTrip;
...
public class DetailedTripFragmentPM extends BasePresenter<DetailedTripFragmentPM.View> {
    ...
    public void loadTripDetails() {
        ...
        dreamSpiceManager.execute(new GetTripDetails(trip.getId()), callback);
    }
    ...
    public void actionLike() {
        ...
        if (trip.isLiked()) {
            dreamSpiceManager.execute(new LikeTrip(trip.getId()), callback2);
        } else {
            dreamSpiceManager.execute(new UnlikeTrip(trip.getId()), callback2);
        }
    }
