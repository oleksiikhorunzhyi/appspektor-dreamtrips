...
public class FeedItemConverter implements Converter<EntityHolder, FeedEntityHolder> {
   ...
   private TargetClassInfo getTargetClassInfo(Object entity) {
      ...
      if (entity instanceof Photo) {
         return new TargetClassInfo(FeedEntityHolder.Type.PHOTO,
               com.worldventures.dreamtrips.social.ui.tripsimages.model.Photo.class);
      }
      if (entity instanceof BucketItem) {
         return new TargetClassInfo(FeedEntityHolder.Type.BUCKET_LIST_ITEM,
               com.worldventures.dreamtrips.social.ui.bucketlist.model.BucketItem.class);
      }
   ...
   private FeedItem.Action mapAction(com.worldventures.dreamtrips.api.feed.model.FeedItem.Action action) {
      switch (action) {
         case ADD:
            return com.worldventures.dreamtrips.social.ui.feed.model.FeedItem.Action.ADD;
         case BOOK:
            return com.worldventures.dreamtrips.social.ui.feed.model.FeedItem.Action.BOOK;
         case COMMENT:
            return com.worldventures.dreamtrips.social.ui.feed.model.FeedItem.Action.COMMENT;
         case LIKE:
            return com.worldventures.dreamtrips.social.ui.feed.model.FeedItem.Action.LIKE;
         case REJECT_REQUEST:
            return com.worldventures.dreamtrips.social.ui.feed.model.FeedItem.Action.REJECT_REQUEST;
         case ACCEPT_REQUEST:
            return com.worldventures.dreamtrips.social.ui.feed.model.FeedItem.Action.ACCEPT_REQUEST;
         case SEND_REQUEST:
            return com.worldventures.dreamtrips.social.ui.feed.model.FeedItem.Action.SEND_REQUEST;
         case SHARE:
            return com.worldventures.dreamtrips.social.ui.feed.model.FeedItem.Action.SHARE;
         case TAG_PHOTO:
            return com.worldventures.dreamtrips.social.ui.feed.model.FeedItem.Action.TAG_PHOTO;
         case UPDATE:
