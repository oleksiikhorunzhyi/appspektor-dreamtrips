package com.worldventures.dreamtrips.social.ui.feed.view.custom.collage;
...
public class CollageView extends FrameLayout {
   ...
   public CollageView(Context context, AttributeSet attrs, int defStyle) {
      ...
      TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CollageView, 0, 0);
