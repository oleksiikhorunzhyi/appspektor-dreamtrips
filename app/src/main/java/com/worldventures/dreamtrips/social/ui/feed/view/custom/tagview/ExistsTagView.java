...
import com.worldventures.dreamtrips.social.ui.feed.view.custom.tagview.viewgroup.ExistsTagViewListener;
...
public class ExistsTagView extends TagView<ExistsTagViewListener> implements View.OnClickListener {
   ...
   @InjectView(R.id.tagged_user_name) protected TextView taggedUserName;
   @InjectView(R.id.tagged_user_delete_tag_divider) protected View divider;
   @InjectView(R.id.tagged_user_delete_tag) protected View btnDeleteTag;
