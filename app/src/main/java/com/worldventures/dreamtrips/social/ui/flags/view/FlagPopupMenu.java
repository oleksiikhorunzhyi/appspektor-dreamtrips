package com.worldventures.dreamtrips.social.ui.flags.view;
...
public class FlagPopupMenu extends PopupMenu {
   ...
   private void showFlagConfirmDialog(Flag flag, String reason) {
      String content = context.getResources().getString(R.string.flag_content_message) + " " + flag.getName()
            .toLowerCase() + " " + context.getResources().getString(R.string.flag_photo_second);
      new MaterialDialog.Builder(context).title(R.string.flag_photo_title)
            .content(content)
   ...
   private void showFlagDescription(Flag flag) {
      MaterialDialog dialog = new MaterialDialog.Builder(context).title(R.string.flag_description_title)
