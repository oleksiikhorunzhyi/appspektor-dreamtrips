...
public abstract class AuthorizedStaticInfoFragment<P extends Parcelable> extends StaticInfoFragment<AuthorizedStaticInfoPresenter, P> implements AuthorizedStaticInfoPresenter.View {
   ...
   public void afterCreateView(View rootView) {
      ...
      //Mixed Content: The page at 'https://secure.worldventures.biz/(S(2l0jz1vwma03azykskghv03o))/Checkout/ShoppingCart.aspx?did=ODg4ODg4&pn=V1ZCaXoy'
      // was loaded over HTTPS, but requested an insecure image 'http://secure.worldventures.biz/(S(2l0jz1vwma03azykskghv03o))/Controls/ImageCreator.aspx?Id=2'.
