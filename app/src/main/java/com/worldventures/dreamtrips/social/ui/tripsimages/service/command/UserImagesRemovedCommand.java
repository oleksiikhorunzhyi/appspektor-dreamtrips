...
@CommandAction
public class UserImagesRemovedCommand extends Command<List<BaseMediaEntity>> implements CachedAction<List<BaseMediaEntity>> {

   TripImagesArgs tripImagesArgs;
   List<BaseMediaEntity> baseMediaEntities;

   public UserImagesRemovedCommand(TripImagesArgs tripImagesArgs, List<BaseMediaEntity> baseMediaEntities) {
