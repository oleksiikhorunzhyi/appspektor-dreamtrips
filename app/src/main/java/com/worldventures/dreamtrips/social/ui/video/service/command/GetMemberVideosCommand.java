...
public class GetMemberVideosCommand extends CommandWithError<List<VideoCategory>> implements InjectableAction {
   ...
   public static GetMemberVideosCommand forRepVideos(com.worldventures.dreamtrips.social.ui.video.model.VideoLanguage videoLanguage) {
   ...
   public static GetMemberVideosCommand forHelpVideos(com.worldventures.dreamtrips.social.ui.video.model.VideoLanguage videoLanguage) {
   ...
   public static GetMemberVideosCommand forHelpSmartCardVideos(com.worldventures.dreamtrips.social.ui.video.model.VideoLanguage videoLanguage) {
