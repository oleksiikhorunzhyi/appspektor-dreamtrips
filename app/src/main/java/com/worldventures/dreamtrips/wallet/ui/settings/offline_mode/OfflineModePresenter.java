...
public class OfflineModePresenter extends WalletPresenter<OfflineModePresenter.Screen, Parcelable> {
   ...
   OfflineModePresenter(Context context, Injector injector) {
