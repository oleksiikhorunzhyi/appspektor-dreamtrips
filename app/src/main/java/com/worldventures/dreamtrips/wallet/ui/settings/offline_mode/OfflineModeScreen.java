...
public class OfflineModeScreen extends WalletLinearLayout<OfflineModePresenter.Screen, OfflineModePresenter, OfflineModePath> implements OfflineModePresenter.Screen {
   ...
   public OfflineModeScreen(Context context) {
      super(context);
   }

   public OfflineModeScreen(Context context, AttributeSet attrs) {
      super(context, attrs);
   }

   @NonNull
   @Override
   public OfflineModePresenter createPresenter() {
      return new OfflineModePresenter(getContext(), getInjector());
   }
