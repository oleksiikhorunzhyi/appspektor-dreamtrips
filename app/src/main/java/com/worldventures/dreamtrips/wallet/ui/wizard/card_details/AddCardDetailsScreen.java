...
public class AddCardDetailsScreen extends WalletFrameLayout<AddCardDetailsPresenter.Screen, AddCardDetailsPresenter, AddCardDetailsPath>
    ...
    @InjectView(R.id.use_default_address_checkbox)
    CheckBox useDefaultAddressCheckBox;
    ...
    @InjectView(R.id.zip)
    EditText zip;
    @InjectView(R.id.card_nickname)
    EditText cardNickname;

    @InjectView(R.id.set_default_address_checkBox)
    CheckBox setDefaultAddressCheckBox;
    @InjectView(R.id.set_default_card_checkBox)
    CheckBox setDefaultPaymentCard;

    @InjectView(R.id.default_address_text)
    TextView defaultAddressText;
    @InjectView(R.id.address_info)
    View addressInfoContainer;
