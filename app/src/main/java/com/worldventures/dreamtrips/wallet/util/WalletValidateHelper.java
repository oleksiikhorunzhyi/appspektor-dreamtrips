...
public class WalletValidateHelper {
    ...
    public static boolean validateAddressInfo(AddressInfo addressInfo){
        boolean infoInvalid = TextUtils.isEmpty(addressInfo.address1())
                || TextUtils.isEmpty(addressInfo.address2())
                || TextUtils.isEmpty(addressInfo.city())
                || TextUtils.isEmpty(addressInfo.state())
                || TextUtils.isEmpty(addressInfo.zip());
