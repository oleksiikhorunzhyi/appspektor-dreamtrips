...
public class LoadConversationDelegateTest extends MessengerBaseTest {
   ...
   static {
      testConversation = ImmutableConversation.builder()
   ...
   public void setup() {
      ...
      Mockito.doReturn(Observable.just(Collections.emptyList())).when(usersDelegate).loadAndSaveUsers(Mockito.any());
   ...
   public void testLoadConversationCommand() {
      ...
      loadConversationDelegate.loadConversationFromNetwork(testConversationId).subscribe(subscriber);
