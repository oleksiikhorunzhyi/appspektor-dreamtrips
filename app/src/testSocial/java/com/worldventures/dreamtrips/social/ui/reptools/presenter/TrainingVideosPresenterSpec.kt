...
import com.worldventures.dreamtrips.social.ui.video.presenter.stubVideo
...
class TrainingVideosPresenterSpec : PresenterBaseSpec({
   ...
   companion object {
      ...
      lateinit var presenter: TrainingVideosPresenter
      lateinit var view: TrainingVideosPresenter.View
