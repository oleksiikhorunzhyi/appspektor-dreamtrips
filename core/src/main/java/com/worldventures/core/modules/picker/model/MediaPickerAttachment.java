...
public class MediaPickerAttachment implements Parcelable {
   ...
   public MediaPickerAttachment(PhotoPickerModel chosenImage, int requestId) {
      this(Collections.singletonList(chosenImage), null, requestId);
   }
   ...
   public static final Creator<MediaPickerAttachment> CREATOR = new Creator<MediaPickerAttachment>() {
      @Override
      public MediaPickerAttachment createFromParcel(Parcel source) {
         return new MediaPickerAttachment(source);
      }

      @Override
      public MediaPickerAttachment[] newArray(int size) {
         return new MediaPickerAttachment[size];
      }
   };
