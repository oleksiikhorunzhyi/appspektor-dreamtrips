...
import com.worldventures.dreamtrips.api.fixtures.util.FixtureAnnotations;
...
import com.worldventures.dreamtrips.api.http.executor.SimpleActionExecutor;
...
public class BaseTest implements ActionExecutor {
    ...
    protected final AuthorizedActionExecutor as(UserCredential credential) {
        ...
        LoginHttpAction action = executor.authorize();
