...
public class UploadImageHttpAction extends BaseUploadImageHttpAction {

    private static final String UPLOAD_URL_SUFFIX = "/upload";

    public UploadImageHttpAction(String uploaderyURL, File imageFile) throws IOException {
