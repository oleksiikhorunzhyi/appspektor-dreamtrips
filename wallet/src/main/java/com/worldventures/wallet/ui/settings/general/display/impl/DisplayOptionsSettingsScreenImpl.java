...
import com.worldventures.wallet.ui.settings.general.display.DisplayOptionsClickListener;
import com.worldventures.wallet.ui.settings.general.display.DisplayOptionsPagerAdapter;
...
import com.worldventures.wallet.ui.settings.general.display.DisplayOptionsViewHolder;
   ...
   public OperationView<SaveDisplayTypeCommand> provideSaveDisplayTypeOperationView() {
      return new ComposableOperationView<>(new SimpleDialogProgressView<>(getContext(), R.string.wallet_settings_general_display_updating, false),
            ...
            ErrorViewFactory.<SaveDisplayTypeCommand>builder()
                  ...
                  .defaultErrorView(new RetryDialogErrorView<>(getContext(), R.string.wallet_error_something_went_wrong, retryAction -> saveCurrentChoice()))
                  .build()
      );
   }
