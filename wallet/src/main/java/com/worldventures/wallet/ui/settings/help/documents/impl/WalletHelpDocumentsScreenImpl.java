...
import com.worldventures.wallet.ui.settings.help.documents.holder.DocumentHolder;
import com.worldventures.wallet.ui.settings.help.documents.holder.HelpDocsHolderFactoryImpl;
...
public class WalletHelpDocumentsScreenImpl extends WalletBaseController<WalletHelpDocumentsScreen, WalletHelpDocumentsPresenter> implements WalletHelpDocumentsScreen {
   ...
   private void setUpView() {
      ...
      statePaginatedRecyclerViewManager = new StatePaginatedRecyclerViewManager(getView().findViewById(R.id.recyclerView),
            getView().findViewById(R.id.swipe_container));
      statePaginatedRecyclerViewManager.getStateRecyclerView().setEmptyView(errorTv);
