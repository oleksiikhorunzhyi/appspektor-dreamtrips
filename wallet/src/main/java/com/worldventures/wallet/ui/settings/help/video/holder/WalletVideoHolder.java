...
import com.worldventures.wallet.ui.settings.help.video.holder.WalletVideoHolderDelegate.WalletVideoHolderHelper;
...
public class WalletVideoHolder extends BaseHolder<WalletVideoModel> {
   ...
   private final ItemWalletVideoBinding binding;
   ...
   public WalletVideoHolder(ItemWalletVideoBinding binding,
